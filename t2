...
<body>
    <div class="container">
        ...
        <div id="registration" class="card">
            <h1 style="text-align: center; color: #8A2BE2; margin-bottom: 30px;">📚 MIL 2nd Quarter SUMMATIVE TEST 2</h1>
            <form id="studentForm">
        ...
        const questions = [
            {
                ...
                choices: ["People who serve as channels of information and knowledge", "People who use media only for entertainment", "People who manage media companies", "People who create advertisements"],
                correct: 0
            },
            {
                question: "Which of the following best describes People as Media?",
                choices: ["People who design advertisements", "People who provide reliable information based on their media experience", "People who act in films and TV shows", "People who work as online influencers"],
                correct: 1
            },
            {
                question: "Who are individuals that interpret media messages and influence others' opinions?",
                choices: ["Broadcasters", "Citizen journalists", "Opinion leaders", "Anchors"],
                correct: 2
            },
            {
                question: "The Two-Step Flow Communication Model was developed by ________.",
                choices: ["Marshall McLuhan", "David Berlo", "Paul Lazarsfeld, Bernard Berelson, and Hazel Gaudet", "Wilbur Schramm"],
                correct: 2
            },
            {
                question: "People who report events using social media without formal journalism training are called ________.",
                choices: ["Citizen journalists", "Print reporters", "News anchors", "Commentators"],
                correct: 0
            },
            {
                question: "Social Journalism mainly uses which platform to reach wider audiences?",
                choices: ["Radio", "Television", "Social media platforms", "Newspapers"],
                correct: 2
            },
            {
                question: "What do you call the practice of obtaining ideas or content from a large group of online users?",
                choices: ["Outsourcing", "Sponsorship", "Crowdsourcing", "Advertising"],
                correct: 2
            },
            {
                question: "People in Media are ________.",
                choices: ["Celebrities who endorse products", "Online influencers only", "Media practitioners who share information from their expertise", "Students of journalism"],
                correct: 2
            },
            {
                question: "Which of the following is not a type of journalist by medium?",
                choices: ["Political journalist", "Broadcast journalist", "Multimedia journalist", "Print journalist"],
                correct: 0
            },
            {
                question: "The case of Nestor Punzalan being wrongfully accused online shows ________.",
                choices: ["The spread of fake news", "The danger of misinformation in social media", "The growth of online audiences", "The decline of citizen journalism"],
                correct: 1
            },
            {
                question: "A positive effect of citizen journalism was shown when ________.",
                choices: ["People spread false information", "News organizations lost credibility", "Social media helped identify the real suspect in a crime", "Videos were deleted after posting"],
                correct: 2
            },
            {
                question: "One disadvantage of People as Media is that ________.",
                choices: ["They are always credible sources", "They may lack accuracy and verification", "They refuse to use media platforms", "They control all media industries"],
                correct: 1
            },
            {
                question: "People in Media differ from People as Media because they ________.",
                choices: ["Are professionals working in media organizations", "Are untrained citizens", "Are limited to social media use", "Are part-time reporters"],
                correct: 0
            },
            {
                question: "Which of the following is an example of Crowdsourcing?",
                choices: ["Watching TV news", "Reading a newspaper", "Using Wikipedia to collaboratively share information", "Listening to radio reports"],
                correct: 2
            },
            {
                question: "As responsible media users, we must ________.",
                choices: ["Verify facts before sharing information online", "Believe everything we see on social media", "Avoid using media completely", "Post unverified information"],
                correct: 0
            }
        ];
...
<script>(function(){function c(){var b=a.contentDocument||a.contentWindow.document;if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'990f03822087febc',t:'MTc2MDg2MzY3OC4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
</html>
